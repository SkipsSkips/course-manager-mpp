...
const Sidebar = ({ onSearch, onFilter, onSort, activeCategory = 'All' }) => {
  ...
  return (
    <>
      ...
      <div
        className={`w-64 bg-gray-100 fixed top-0 left-0 bottom-0 transform transition-transform duration-300 ease-in-out ${
          isOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0 z-10 shadow-xl overflow-y-auto`}
        style={{ paddingTop: "4rem" }} /* Fixed top padding to avoid navbar overlap */
      >
        <div className="p-6">
